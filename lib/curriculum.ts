import type { Lesson, SkillLevel, Achievement } from "./types"

export const SKILL_LEVELS: SkillLevel[] = [
  { id: 1, name: "Novice", minPoints: 0, color: "bg-gray-500" },
  { id: 2, name: "Apprentice", minPoints: 100, color: "bg-blue-500" },
  { id: 3, name: "Journeyman", minPoints: 300, color: "bg-green-500" },
  { id: 4, name: "Expert", minPoints: 600, color: "bg-yellow-500" },
  { id: 5, name: "Master", minPoints: 1000, color: "bg-orange-500" },
  { id: 6, name: "Grandmaster", minPoints: 1500, color: "bg-red-500" },
  { id: 7, name: "Virtuoso", minPoints: 2000, color: "bg-purple-500" },
]
...
// Representing the new module structure
interface Module {
  id: string;
  title: string;
  description: string;
...
export const CURRICULUM_MODULES: Module[] = [
  {
    id: "intro-partimento",
    title: "Introduction to Partimento",
    description:
      "Learn the fundamentals of partimento - the historical method of teaching composition and improvisation through figured bass.",
    lessons: [
      {
        id: "what-is-partimento",
        title: "What is Partimento?",
        content: `
# What is Partimento?

Partimento is a historical method of teaching composition and improvisation that was used in Italian conservatories during the 18th century. The word "partimento" comes from the Italian verb "partire," meaning "to divide" or "to depart from."

## Key Concepts

1. **Bass Line Foundation**: A partimento is essentially a bass line, often with figured bass numbers, that serves as the foundation for improvisation.

2. **Practical Learning**: Students learned by doing - playing and improvising at the keyboard rather than just analyzing on paper.

3. **Pattern Recognition**: Through repeated practice, students internalized common harmonic and melodic patterns.

4. **Historical Importance**: This method trained composers like Mozart, Haydn, and countless Italian masters.

## Why Study Partimento Today?

- Develops practical keyboard skills
- Builds intuitive understanding of harmony
- Connects theory with performance
- Provides insight into historical composition practices
        `,
        exercises: [
          {
            id: "intro-1",
            type: "multiple-choice",
            prompt: "What does the word 'partimento' mean?",
            correctAnswer: "To divide or depart from",
            options: [
              "To divide or depart from",
              "To compose music",
              "To play the bass",
              "To improvise freely",
            ],
            hints: [
              "Think about the Italian verb 'partire'",
              "It relates to starting from something as a foundation",
            ],
          },
          {
            id: "intro-2",
            type: "multiple-choice",
            prompt: "What is the primary foundation of a partimento exercise?",
            correctAnswer: "A bass line",
            options: [
              "A melody",
              "A bass line",
              "A chord progression",
            ...
            hints: [
              "Partimento starts from the bottom up",
              "The foundation is in the lowest voice",
            ],
          },
        ],
      },
      {
        id: "figured-bass-basics",
        title: "Figured Bass Basics",
        content: `
# Figured Bass Notation

Figured bass is a numerical shorthand that indicates which intervals should be played above the bass note.

## Basic Figures

- **No figure or 5/3**: Root position triad (play the 3rd and 5th above the bass)
- **6 or 6/3**: First inversion triad (play the 3rd and 6th above the bass)
- **6/4**: Second inversion triad (play the 4th and 6th above the bass)
- **7**: Seventh chord (add a 7th to the triad)

## Reading Figures

When you see a bass note with figures below it:
1. The bass note is always played in the left hand
2. The figures tell you which intervals to add above it in the right hand
3. You fill in the harmony to create complete chords

## Example

Bass note: C with figure 6
- Play C in the left hand
- Play E (a 3rd above) and A (a 6th above) in the right hand
- This creates a first inversion A minor chord
        `,
        exercises: [
          {
            id: "fb-1",
            type: "multiple-choice",
            prompt: "What does the figure '6' indicate?",
            correctAnswer: "First inversion triad (6/3)",
            options: [
              "Root position triad",
            ...
            hints: [
              "The figure 6 is shorthand for 6/3",
              "This indicates a first inversion chord",
            ],
          },
          {
            id: "fb-2",
            type: "multiple-choice",
            prompt: "In figured bass, where is the bass note played?",
            correctAnswer: "Left hand",
            options: ["Right hand", "Left hand", "Both hands", "Either hand"],
            hints: [
              "The bass is the foundation",
              "Typically, the left hand plays the bass line",
            ],
          },
          {
            id: "fb-3",
            type: "keyboard",
            prompt":
              "KEYBOARD: Play a C major triad in root position. Bass note C, figures 5/3 (or no figures).",
            correctAnswer":
              "Play bass note C with left hand, and complete triads (C-E-G) with right hand",
            hints": [
              "Root position means the root (C) is in the bass",
              "Add the 3rd (E) and 5th (G) above the bass",
            ],
          },
          {
            id: "fb-4",
            type: "keyboard",
            prompt":
              "KEYBOARD: Realize this simple progression: Bass notes C-F-G-C with figures 5/3 on each.",
            correctAnswer":
          ...
          },
          {
            ...
            type: "melody",
            prompt":
              "MELODIES: Create a melodic line over this progression: I-IV-V-I",
            correctAnswer":
              "Any melodic line using chord tones and passing notes that fits the harmony",
            hints": [
              "Start with chord tones (notes from each chord)",
              "Add passing notes to connect chord tones smoothly",
            ],
          },
        ],
      },
  ...
  // ============================================
  {
    id: "foundations",
    title: "Foundations",
    description: "Build your understanding of baroque harmony and notation",
    lessons: [
      {
        ...
        content: {
          ...
          exercises: [
            ...
            },
            {
              ...
              correctAnswer":
                "Improvise a melody using notes from each chord, emphasizing stepwise motion to match the smooth bass line",
              hints": [
      ...
      },
      {
        ...
        content: {
          theory:
            "6/4 indicates second inversion. The bass has the 5th of the chord. In C major, bass note 5 with 6/4 = G-C-E. The 6/4 is unstable and usually resolves to 5/3. The most important use is the cadential 6/4: I6/4 on a strong beat resolves to V on the next beat, creating a powerful cadence. Passing 6/4 and pedal 6/4 are also common.",
          examples: [
            {
              id: "ex-1",
          ...
          exercises: [
            ...
            },
            {
              ...
              correctAnswer": "Play bass G in bass twice, right hand plays C-E-G (6/4) then B-D-G (5/3), then resolve to C-E-G over bass C",
              hints": [
        ...
        content: {
          ...
          exercises: [
            ...
            },
            {
              id: "ex5-8-keyboard",
              type: "play",
              prompt": "KEYBOARD: Realize a Compound Cadence in C major. Bass: G-G-C with figures 5/4-5/3-5/3. The 4-3 suspension creates the compound effect.",
            ...
            },
            {
              id: "ex5-9-keyboard",
              type: "play",
              prompt": "KEYBOARD: Realize a Double Cadence in C major. Bass: G-G-G-G-C with figures 5/3-6/4-5/4-7/3-5/3. This is the most elaborate cadence.",
        ...
        content: {
          ...
          exercises: [
            ...
            },
            {
              id: "sfa-7-melodic",
              type: "play",
              prompt": "MELODIES: Create a simple melodic line over the Sol-Fa-Mi bass in C major (G-F-E). Focus on stepwise motion and fitting the harmony.",
              bassPattern: "G3-F3-E3",
              beatsPerNote: 4,
              tempo: 80,
              correctAnswer": "A stepwise melody that fits the harmony",
              hints": [
                "Try starting on B (7) or D (2) over G",
            ...
            },
            {
              ...
              type: "play",
              prompt":
                "COMBINATION: Create a 12-bar rounded binary form combining Romanesca, Do-Re-Mi, and Sol-Fa-Mi. Structure: Bars 1-4: Romanesca (C-B-A-G). Bars 5-8: Do-Re-Mi (C-D-E) sequenced to (F-G-A). Bars 9-12: Sol-Fa-Mi (G-F-E) with final cadence to C.",
        ...
        content: {
          ...
          exercises: [
            ...
            },
            {
              id: "dim2-4-keyboard",
              type: "play",
              prompt": "KEYBOARD: Play a simple I chord in C major (C-E-G). Now realize it with 2:1 diminution in the soprano. Bass: C. Soprano: C-D-E-C.",
            ...
            },
            {
              id: "dim2-5-keyboard",
              type: "play",
              prompt": "KEYBOARD: Play a V-I cadence in C major. Bass: G-C. Realize the soprano with 2:1 diminution, emphasizing the resolution. Soprano over G: D-E-F-D. Soprano over C: C-B-A-C.",
        ...
        content: {
          ...
          exercises: [
            ...
            },
            {
              id: "prinner-2",
              type: "identify",
              prompt": "In C major, what are the bass notes for the Prinner schema?",
            ...
            },
            {
              ...
              type: "play",
              prompt": "MELODIES: Create a lyrical melody over the Prinner bass in C major (A-G-F-E). Focus on contrary motion to the bass.",
          ...
          historicalContext:
            "The Prinner schema, named after the 17th-century composer Johann Jakob Prinner, is a foundational pattern in galant music. Its graceful descending bass line, combined with smooth chordal harmony, makes it a popular choice for opening musical phrases. Composers like Haydn and Mozart frequently employed this schema, recognizing its effectiveness in establishing a pleasing and idiomatic musical texture. Its predictable structure also made it an excellent tool for improvisers.",
        },
      },
      {
        id: "inter-2-meyer",
      ...
      },
      {
        ...
        description: "Master the descending sequential pattern",
        category: "schemata",
        tradition: "italian",
        difficulty: "intermediate",
        level: 3,
          ...
          exercises: [
            {
              ...
              options": ["Descending stepwise", "Ascending stepwise", "Leaping by fourths", "Arpeggiated chords"],
              correctAnswer": "Ascending stepwise",
            ...
            },
            {
              ...
              options": ["Gentle descent and resolution", "Tension and anticipation", "Excitement and forward motion", "Melancholy and sadness"],
        ...
        content: {
          ...
          examples: [
            {
              ...
              description": "Bass: G (sustained) | Upper voices move through V7, I6/4, V7, I. (In C major)",
          ...
          exercises: [
            ...
            },
            {
              id: "ponte-4-keyboard",
              type: "play",
              prompt": "KEYBOARD: Realize the Ponte schema in C major. Bass: G (sustained for 4 beats). Upper voices create simple chord progression: V7 - I6/4 - V7 - I. (Example voicing: G-B-D-F, G-C-E, G-B-D-F, G-B-D-G)",
        ...
        content: {
          ...
          exercises: [
            ...
            },
            {
              ...
              hints": ["This schema builds tension", "Dominant seventh chords create strong pull towards the tonic"],
            },
            {
              id: "fenaroli-schema-3-keyboard",
              type: "play",
              prompt": "KEYBOARD: Realize the Fenaroli schema in C major. Bass: B-C-B-C. Harmony: V7 - I - V7 - I. Soprano: F-E-F-E.",
        ...
        content: {
          ...
          exercises: [
            ...
            },
            {
              ...
              type: "play",
              prompt": "KEYBOARD: Realize the Indugio schema in C major. Bass: F (sustained for 4 beats). Upper voices: I6 - V/V - IV. (Example voicing: F-A-C, F-G-B, F-A-C).",
      ...
      },
      {
        ...
        content: {
          ...
          historicalContext:
            "The Pastorella schema, evoking scenes of rural life, was a popular device in Baroque and Galant music to create a serene and idyllic atmosphere. Composers like Handel and Bach utilized this schema in arias, instrumental movements, and vocal works to depict pastoral settings or moments of tranquility. Its simplicity, characterized by a drone bass and folk-like melodies, made it highly effective in conveying a sense of peace and innocence.",
        },
      },
      {
        id: "adv-6-quieszenza",
        ...
        content: {
          ...
          historicalContext:
            "The Quieszenza (Italian for 'rest' or 'calm') is a descending stepwise schema that creates a sense of peaceful resolution. It was frequently used by composers like Handel and Vivaldi to conclude phrases with elegance and repose.",
        },
      },
    ],
  },
  {
    ...
    description: "Learn fundamental harmonic and melodic patterns",
    lessons: [
      {
        id: "basic-1-simple-suspensions",
        title: "Simple Suspensions: 4-3",
      ...
      // ============================================
      {
        ...
        content: {
          ...
          historicalContext:
            "The Prinner schema, named after the 1
