...
import { isDeveloperMode } from "@/lib/progress-storage"
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            ...
            {devMode && " • All lessons unlocked for testing"}
          </CardDescription>
        </CardHeader>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {filteredLessons.map((lesson) => {
          ...
          const isLocked = !devMode && status === "locked"
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      {status === "locked" && !devMode && <Lock className="w-4 h-4 text-muted-foreground" />}
